...
* `ПОДЦИТАТА(строка, от, длина)` — Возвращает фрагмент строки с, начиная с индекса от длиной дл. 
Если индекс от вне границ, возвращает пустую строку.
* `ПОИСК(где, что)` — Ищет первое вхождение подстроки что в строке где. Возвращает индекс (тип ЦИФЕРКА) начала или -1, если вхождение не найдено..
