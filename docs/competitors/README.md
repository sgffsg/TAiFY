...
Pascal проще для учебных целей благодаря строгой структуре и минимализму конструкций. C++ требует обработки сложных выражений, указателей и контекстно-зависимого анализа, что демонстрирует реальные сложности промышленных языков.