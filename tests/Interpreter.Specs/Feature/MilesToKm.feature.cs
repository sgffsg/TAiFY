...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Feature/MilesToKm.feature.ndjson", 3);
        }
...
#line 5
        await testRunner.GivenAsync("я подготовил код программы:", @"(ПОЯСНИТЕЛЬНАЯ-БРИГАДА: Глобальная константа для перевода)
