...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Feature/CircleSquare.feature.ndjson", 3);
        }
...
#line 5
        await testRunner.GivenAsync("я подготовил код программы:", "БАЗА ПОЛТОРАШКА ПИ = 3.1415926535;\r\n\r\nПРОКРАСТИНИРУЕМ ПОГНАЛИ() \r\nПОЕХАЛИ\r\n    ПО" +
                        "ЛТОРАШКА радиус = 0.0;\r\n\r\n    ВБРОС(радиус);\r\n\r\n    ПОЛТОРАШКА площадьКруга = ПИ" +
